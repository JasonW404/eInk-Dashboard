...
from inkpi.network.network_helper import (
    CommandStep,
    _nat_disable_steps,
    _nat_enable_steps,
    _upstream_interface,
...
from inkpi.network.operations import NetworkOperationRequest, build_operation_request
from inkpi.network.privileged import _execute_step
...
def test_optional_step_failure_returns_ok() -> None:
    ...
    with patch("inkpi.network.privileged.subprocess.run", return_value=proc):
